...
class __declspec( dllexport ) CListBoxEx : public CDragListBox
{
...
class __declspec( dllexport ) CListBoxExBuddy: public CWnd
{
public:
...
class __declspec( dllexport ) CMyListBoxEx: public CListBoxEx
{
public:
