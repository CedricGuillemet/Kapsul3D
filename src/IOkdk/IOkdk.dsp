# Microsoft Developer Studio Project File - Name="IOkdk" - Package Owner=<4>
...
# ADD LINK32 opengl32.lib Kore.lib /nologo /subsystem:windows /dll /machine:I386 /out:"../plugins/iokdk.dll"
...
# ADD LINK32 opengl32.lib Kore.lib /nologo /subsystem:windows /dll /debug /machine:I386 /out:"../plugins/iokdk.dll" /pdbtype:sept

!ENDIF 

# Begin Target

# Name "IOkdk - Win32 Release"
# Name "IOkdk - Win32 Debug"
