...
# ADD LINK32 Kore.lib opengl32.lib /nologo /subsystem:windows /dll /machine:I386 /def:".\IOmd2.def" /out:"../workspace/plugins/iomd2.dll" /ALIGN:4096
...
# ADD LINK32 opengl32.lib Kore.lib /nologo /subsystem:windows /dll /debug /machine:I386 /out:"../workspace/plugins/iomd2.dll" /pdbtype:sept
