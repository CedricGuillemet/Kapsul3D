...
/////////////////////////////////////////////////////////////////////////////
// CMatBrowserDialogBar

CMatBrowserDialogBar::CMatBrowserDialogBar() : 
...
BEGIN_MESSAGE_MAP(CMatBrowserDialogBar, CControlBar)
    //{{AFX_MSG_MAP(CMatBrowserDialogBar)
    ON_WM_LBUTTONUP()
    ON_WM_MOUSEMOVE()
    ON_WM_SETCURSOR()
...
/////////////////////////////////////////////////////////////////////////////
// CMatBrowserDialogBar message handlers

void CMatBrowserDialogBar::OnUpdateCmdUI(class CFrameWnd *pTarget, int bDisableIfNoHndler)
{
    UpdateDialogControls(pTarget, bDisableIfNoHndler);
}

BOOL CMatBrowserDialogBar::Create(CWnd* pParentWnd, CMatBrowser *pDialog, CString &pTitle, UINT nID, DWORD dwStyle) 
{
...
CSize CMatBrowserDialogBar::CalcFixedLayout(BOOL bStretch, BOOL bHorz)
{
    CRect rc;
...
CSize CMatBrowserDialogBar::CalcDynamicLayout(int nLength, DWORD dwMode)
{
...
void CMatBrowserDialogBar::OnWindowPosChanged(WINDOWPOS FAR* lpwndpos) 
{
...
BOOL CMatBrowserDialogBar::OnSetCursor(CWnd* pWnd, UINT nHitTest, UINT message) 
{
...
// Mouse Handling
//
void CMatBrowserDialogBar::OnLButtonUp(UINT nFlags, CPoint point) 
{
    if (!m_bTracking)
...
void CMatBrowserDialogBar::OnMouseMove(UINT nFlags, CPoint point) 
{
...
void CMatBrowserDialogBar::OnNcCalcSize(BOOL bCalcValidRects, NCCALCSIZE_PARAMS FAR* lpncsp) 
{
...
void CMatBrowserDialogBar::OnNcPaint() 
{
    EraseNonClient();
...
void CMatBrowserDialogBar::OnNcLButtonDown(UINT nHitTest, CPoint point) 
{
...
UINT CMatBrowserDialogBar::OnNcHitTest(CPoint point) 
{
    if (IsFloating())
...
void CMatBrowserDialogBar::OnLButtonDown(UINT nFlags, CPoint point) 
{
...
void CMatBrowserDialogBar::OnLButtonDblClk(UINT nFlags, CPoint point) 
{
...
void CMatBrowserDialogBar::StartTracking()
{
    SetCapture();
...
void CMatBrowserDialogBar::OnCaptureChanged(CWnd *pWnd) 
{
...
void CMatBrowserDialogBar::StopTracking(BOOL bAccept)
{
    OnInvertTracker(m_rectTracker);
...
void CMatBrowserDialogBar::OnInvertTracker(const CRect& rect)
{
    ASSERT_VALID(this);
...
BOOL CMatBrowserDialogBar::IsHorz() const
{
    return (m_nDockBarID == AFX_IDW_DOCKBAR_TOP ||
        m_nDockBarID == AFX_IDW_DOCKBAR_BOTTOM);
}

CPoint& CMatBrowserDialogBar::ClientToWnd(CPoint& point)
{
...
void CMatBrowserDialogBar::DrawGripper(CDC & dc)
{
...
void CMatBrowserDialogBar::OnNcLButtonDblClk(UINT nHitTest, CPoint point) 
{
...
void CMatBrowserDialogBar::OnSizing( UINT nSide, LPRECT lpRect )
{
...
void CMatBrowserDialogBar::OnSize( UINT nType, int cx, int cy )
{
