...
void CSkyBoxEd::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_CL1BACK, m_CL1BACK);
	DDX_Control(pDX, IDC_CL1FRONT, m_CL1FRONT);
	DDX_Control(pDX, IDC_CL1RIGHT, m_CL1RIGHT);
	DDX_Control(pDX, IDC_CL1LEFT, m_CL1LEFT);
	DDX_Control(pDX, IDC_CL1DOWN, m_CL1DOWN);
	DDX_Control(pDX, IDC_CL1UP, m_CL1UP);
...
BEGIN_MESSAGE_MAP(CSkyBoxEd, CDialog)
	...
	ON_BN_CLICKED(IDC_CL1UP, OnCL1UP)
	ON_BN_CLICKED(IDC_CL1DOWN, OnCL1DOWN)
	ON_BN_CLICKED(IDC_CL1LEFT, OnCL1LEFT)
	ON_BN_CLICKED(IDC_CL1RIGHT, OnCL1RIGHT)
	ON_BN_CLICKED(IDC_CL1FRONT, OnCL1FRONT)
	ON_BN_CLICKED(IDC_CL1BACK, OnCL1BACK)
	ON_BN_CLICKED(IDC_CL2UP, OnCL2UP)
	ON_BN_CLICKED(IDC_CL2DOWN, OnCL2DOWN)
	ON_BN_CLICKED(IDC_CL2LEFT, OnCL2LEFT)
	ON_BN_CLICKED(IDC_CL2RIGHT, OnCL2RIGHT)
	ON_BN_CLICKED(IDC_CL2FRONT, OnCL2FRONT)
	ON_BN_CLICKED(IDC_CL2BACK, OnCL2BACK)
...
void CSkyBoxEd::OnL1UP() 
{
    ...
    if (LoadImgFile())
    {
        ...
        csv.cb->Layer1[2]->FileName=filename;
...
void CSkyBoxEd::OnL1DOWN() 
{
    if (LoadImgFile())
    {
        ...
        csv.cb->Layer1[3]->FileName=filename;
...
void CSkyBoxEd::OnL1LEFT() 
{
    if (LoadImgFile())
    {
        ...
        csv.cb->Layer1[4]->FileName=filename;
...
void CSkyBoxEd::OnL1RIGHT() 
{
    if (LoadImgFile())
    {
        ...
        csv.cb->Layer1[5]->FileName=filename;
...
void CSkyBoxEd::OnL1FRONT() 
{
    if (LoadImgFile())
    {
        ...
        csv.cb->Layer1[1]->FileName=filename;
...
void CSkyBoxEd::OnL1BACK() 
{
    if (LoadImgFile())
    {
        ...
        csv.cb->Layer1[0]->FileName=filename;
...
void CSkyBoxEd::OnL2UP() 
{
    if (LoadImgFile())
    {
        ...
        csv.cb->Layer2[2]->FileName=filename;
...
void CSkyBoxEd::OnL2DOWN() 
{
    if (LoadImgFile())
    {
        ...
        csv.cb->Layer2[3]->FileName=filename;
...
void CSkyBoxEd::OnL2LEFT() 
{
    if (LoadImgFile())
    {
        ...
        csv.cb->Layer2[4]->FileName=filename;
...
void CSkyBoxEd::OnL2RIGHT() 
{
    if (LoadImgFile())
    {
        ...
        csv.cb->Layer2[5]->FileName=filename;
...
void CSkyBoxEd::OnL2FRONT() 
{
    if (LoadImgFile())
    {
        ...
        csv.cb->Layer2[1]->FileName=filename;
...
void CSkyBoxEd::OnL2BACK() 
{
    if (LoadImgFile())
    {
        ...
        csv.cb->Layer2[0]->FileName=filename;
...
{
    csv.cb->Layer2[2]->ComputeAlpha=(m_AUP.GetCheck()==BST_CHECKED);
    csv.cb->Layer2[2]->Load();
    Modified=true;
}
...
{
    csv.cb->Layer2[3]->ComputeAlpha=(m_ADOWN.GetCheck()==BST_CHECKED);
    csv.cb->Layer2[3]->Load();
	Modified=true;
}
...
{
    csv.cb->Layer2[4]->ComputeAlpha=(m_ALEFT.GetCheck()==BST_CHECKED);
    csv.cb->Layer2[4]->Load();
    Modified=true;
...
{
    csv.cb->Layer2[5]->ComputeAlpha=(m_ARIGHT.GetCheck()==BST_CHECKED);
    csv.cb->Layer2[5]->Load();
    Modified=true;
}
...
{
    csv.cb->Layer2[1]->ComputeAlpha=(m_AFRONT.GetCheck()==BST_CHECKED);
    csv.cb->Layer2[1]->Load();
    Modified=true;
}
...
{
    csv.cb->Layer2[0]->ComputeAlpha=(m_ABACK.GetCheck()==BST_CHECKED);
    csv.cb->Layer2[0]->Load();
    Modified=true;
}
