/* $Header: C:/cvs/Repository/Kapsul3D/src/ImageLib/Sources/Sources\040Tiff/tif_write.c,v 1.1 2002/03/29 05:06:27 khurley Exp $ */
...
TIFFWriteEncodedTile(TIFF* tif, ttile_t tile, tdata_t data, tsize_t cc)
{
	 ...
	 */
	if ((int)(uint32) cc > tif->tif_tilesize)
		cc = tif->tif_tilesize;
