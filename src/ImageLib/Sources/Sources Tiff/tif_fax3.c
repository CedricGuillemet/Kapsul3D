/* $Header: C:/cvs/Repository/Kapsul3D/src/ImageLib/Sources/Sources\040Tiff/tif_fax3.c,v 1.1 2002/03/29 05:06:26 khurley Exp $ */
...
Fax3PreDecode(TIFF* tif, tsample_t s)
{
	...
	if (sp->refruns) {		/* init reference line to white */
		sp->refruns[0] = (u_short)sp->b.rowpixels;
		sp->refruns[1] = 0;
	}
	return (1);
}
